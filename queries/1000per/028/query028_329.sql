...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 27 and 27+10 
             or ss_coupon_amt between 11641 and 11641+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 71 and 71+10
          or ss_coupon_amt between 11649 and 11649+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 100 and 100+10
          or ss_coupon_amt between 12047 and 12047+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 9 and 9+10
          or ss_coupon_amt between 13868 and 13868+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 8 and 8+10
          or ss_coupon_amt between 2258 and 2258+1000
