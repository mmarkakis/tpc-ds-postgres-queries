...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 120 and 120+10 
             or ss_coupon_amt between 17133 and 17133+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 16519 and 16519+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 130 and 130+10
          or ss_coupon_amt between 12390 and 12390+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 141 and 141+10
          or ss_coupon_amt between 17469 and 17469+1000
