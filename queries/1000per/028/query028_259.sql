...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 171 and 171+10 
             or ss_coupon_amt between 11864 and 11864+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 172 and 172+10
          or ss_coupon_amt between 6215 and 6215+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 103 and 103+10
          or ss_coupon_amt between 11167 and 11167+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 17834 and 17834+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 90 and 90+10
          or ss_coupon_amt between 11049 and 11049+1000
