     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 4 and 4+10
          or ss_coupon_amt between 199 and 199+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 82 and 82+10
          or ss_coupon_amt between 15155 and 15155+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 101 and 101+10
          or ss_coupon_amt between 13057 and 13057+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 128 and 128+10
          or ss_coupon_amt between 6044 and 6044+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 59 and 59+10
          or ss_coupon_amt between 10944 and 10944+1000
