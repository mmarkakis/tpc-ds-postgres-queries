...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 120 and 120+10 
             or ss_coupon_amt between 17527 and 17527+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 62 and 62+10
          or ss_coupon_amt between 12583 and 12583+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 126 and 126+10
          or ss_coupon_amt between 6653 and 6653+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 60 and 60+10
          or ss_coupon_amt between 16600 and 16600+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 138 and 138+10
          or ss_coupon_amt between 12141 and 12141+1000
