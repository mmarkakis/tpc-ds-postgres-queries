...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 145 and 145+10 
             or ss_coupon_amt between 340 and 340+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 74 and 74+10
          or ss_coupon_amt between 5879 and 5879+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 160 and 160+10
          or ss_coupon_amt between 15293 and 15293+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 67 and 67+10
          or ss_coupon_amt between 3050 and 3050+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 143 and 143+10
          or ss_coupon_amt between 2606 and 2606+1000
