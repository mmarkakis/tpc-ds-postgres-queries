...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 45 and 45+10 
             or ss_coupon_amt between 2291 and 2291+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 66 and 66+10
          or ss_coupon_amt between 16358 and 16358+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 113 and 113+10
          or ss_coupon_amt between 5247 and 5247+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 8 and 8+10
          or ss_coupon_amt between 14636 and 14636+1000
