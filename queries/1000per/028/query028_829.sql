...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 50 and 50+10 
             or ss_coupon_amt between 6075 and 6075+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 18 and 18+10
          or ss_coupon_amt between 15592 and 15592+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 41 and 41+10
          or ss_coupon_amt between 13065 and 13065+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 157 and 157+10
          or ss_coupon_amt between 15717 and 15717+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 94 and 94+10
          or ss_coupon_amt between 736 and 736+1000
