     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 82 and 82+10
          or ss_coupon_amt between 13044 and 13044+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 112 and 112+10
          or ss_coupon_amt between 8766 and 8766+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 141 and 141+10
          or ss_coupon_amt between 8023 and 8023+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 68 and 68+10
          or ss_coupon_amt between 11763 and 11763+1000
