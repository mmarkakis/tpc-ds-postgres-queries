...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 149 and 149+10 
             or ss_coupon_amt between 10540 and 10540+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 58 and 58+10
          or ss_coupon_amt between 14211 and 14211+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 24 and 24+10
          or ss_coupon_amt between 3757 and 3757+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 114 and 114+10
          or ss_coupon_amt between 6994 and 6994+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 61 and 61+10
          or ss_coupon_amt between 3996 and 3996+1000
