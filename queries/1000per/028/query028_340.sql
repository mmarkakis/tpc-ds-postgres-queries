...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 62 and 62+10 
             or ss_coupon_amt between 5060 and 5060+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 100 and 100+10
          or ss_coupon_amt between 3406 and 3406+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 86 and 86+10
          or ss_coupon_amt between 1763 and 1763+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 148 and 148+10
          or ss_coupon_amt between 6197 and 6197+1000
