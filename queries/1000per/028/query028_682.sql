     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 0 and 0+10
          or ss_coupon_amt between 8297 and 8297+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 134 and 134+10
          or ss_coupon_amt between 7288 and 7288+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 121 and 121+10
          or ss_coupon_amt between 14753 and 14753+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 129 and 129+10
          or ss_coupon_amt between 13879 and 13879+1000
