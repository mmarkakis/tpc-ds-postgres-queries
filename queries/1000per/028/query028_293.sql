     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 156 and 156+10
          or ss_coupon_amt between 3009 and 3009+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 158 and 158+10
          or ss_coupon_amt between 1461 and 1461+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 149 and 149+10
          or ss_coupon_amt between 7345 and 7345+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 54 and 54+10
          or ss_coupon_amt between 6541 and 6541+1000
