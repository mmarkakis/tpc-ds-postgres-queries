...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 108 and 108+10 
             or ss_coupon_amt between 3560 and 3560+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 11554 and 11554+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 153 and 153+10
          or ss_coupon_amt between 3371 and 3371+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 75 and 75+10
          or ss_coupon_amt between 10709 and 10709+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 110 and 110+10
          or ss_coupon_amt between 3416 and 3416+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 9 and 9+10
          or ss_coupon_amt between 4220 and 4220+1000
