     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 111 and 111+10
          or ss_coupon_amt between 11739 and 11739+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 127 and 127+10
          or ss_coupon_amt between 2091 and 2091+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 15 and 15+10
          or ss_coupon_amt between 6642 and 6642+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 114 and 114+10
          or ss_coupon_amt between 17280 and 17280+1000
