...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 137 and 137+10 
             or ss_coupon_amt between 12960 and 12960+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 78 and 78+10
          or ss_coupon_amt between 14809 and 14809+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 159 and 159+10
          or ss_coupon_amt between 11875 and 11875+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 32 and 32+10
          or ss_coupon_amt between 7075 and 7075+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 5 and 5+10
          or ss_coupon_amt between 375 and 375+1000
