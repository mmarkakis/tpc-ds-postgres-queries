     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 149 and 149+10
          or ss_coupon_amt between 2420 and 2420+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 27 and 27+10
          or ss_coupon_amt between 2688 and 2688+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 113 and 113+10
          or ss_coupon_amt between 8473 and 8473+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 91 and 91+10
          or ss_coupon_amt between 7816 and 7816+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 174 and 174+10
          or ss_coupon_amt between 10290 and 10290+1000
