...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 62 and 62+10 
             or ss_coupon_amt between 17940 and 17940+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 187 and 187+10
          or ss_coupon_amt between 8360 and 8360+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 75 and 75+10
          or ss_coupon_amt between 546 and 546+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 5 and 5+10
          or ss_coupon_amt between 1336 and 1336+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 95 and 95+10
          or ss_coupon_amt between 17963 and 17963+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 34 and 34+10
          or ss_coupon_amt between 11443 and 11443+1000
