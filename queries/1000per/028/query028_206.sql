...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 133 and 133+10 
             or ss_coupon_amt between 16264 and 16264+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 21 and 21+10
          or ss_coupon_amt between 522 and 522+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 165 and 165+10
          or ss_coupon_amt between 2247 and 2247+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 184 and 184+10
          or ss_coupon_amt between 9710 and 9710+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 177 and 177+10
          or ss_coupon_amt between 3382 and 3382+1000
