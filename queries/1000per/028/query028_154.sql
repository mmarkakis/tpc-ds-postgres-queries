...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 34 and 34+10 
             or ss_coupon_amt between 15055 and 15055+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 157 and 157+10
          or ss_coupon_amt between 5259 and 5259+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 117 and 117+10
          or ss_coupon_amt between 2841 and 2841+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 99 and 99+10
          or ss_coupon_amt between 1955 and 1955+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 161 and 161+10
          or ss_coupon_amt between 4989 and 4989+1000
