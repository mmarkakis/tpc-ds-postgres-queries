...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 167 and 167+10 
             or ss_coupon_amt between 5771 and 5771+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 28 and 28+10
          or ss_coupon_amt between 7759 and 7759+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 177 and 177+10
          or ss_coupon_amt between 15299 and 15299+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 122 and 122+10
          or ss_coupon_amt between 9403 and 9403+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 87 and 87+10
          or ss_coupon_amt between 7690 and 7690+1000
