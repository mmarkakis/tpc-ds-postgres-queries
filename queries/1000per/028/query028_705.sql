...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 58 and 58+10 
             or ss_coupon_amt between 10764 and 10764+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 178 and 178+10
          or ss_coupon_amt between 16308 and 16308+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 57 and 57+10
          or ss_coupon_amt between 6380 and 6380+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 44 and 44+10
          or ss_coupon_amt between 15902 and 15902+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 36 and 36+10
          or ss_coupon_amt between 5936 and 5936+1000
