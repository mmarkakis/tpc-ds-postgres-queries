     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 42 and 42+10
          or ss_coupon_amt between 13948 and 13948+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 187 and 187+10
          or ss_coupon_amt between 3432 and 3432+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 33 and 33+10
          or ss_coupon_amt between 15049 and 15049+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 66 and 66+10
          or ss_coupon_amt between 14174 and 14174+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 148 and 148+10
          or ss_coupon_amt between 13428 and 13428+1000
