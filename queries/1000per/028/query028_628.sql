...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 104 and 104+10 
             or ss_coupon_amt between 10018 and 10018+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 181 and 181+10
          or ss_coupon_amt between 2624 and 2624+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 157 and 157+10
          or ss_coupon_amt between 7023 and 7023+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 57 and 57+10
          or ss_coupon_amt between 17109 and 17109+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 52 and 52+10
          or ss_coupon_amt between 7213 and 7213+1000
