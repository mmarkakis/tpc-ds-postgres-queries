...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 171 and 171+10 
             or ss_coupon_amt between 12008 and 12008+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 58 and 58+10
          or ss_coupon_amt between 8187 and 8187+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 18 and 18+10
          or ss_coupon_amt between 17988 and 17988+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 130 and 130+10
          or ss_coupon_amt between 1133 and 1133+1000
