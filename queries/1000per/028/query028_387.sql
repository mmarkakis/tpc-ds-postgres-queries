...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 55 and 55+10 
             or ss_coupon_amt between 8628 and 8628+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 18 and 18+10
          or ss_coupon_amt between 5304 and 5304+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 185 and 185+10
          or ss_coupon_amt between 11665 and 11665+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 77 and 77+10
          or ss_coupon_amt between 13971 and 13971+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 108 and 108+10
          or ss_coupon_amt between 16623 and 16623+1000
