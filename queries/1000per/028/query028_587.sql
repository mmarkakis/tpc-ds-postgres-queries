...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 93 and 93+10 
             or ss_coupon_amt between 15645 and 15645+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 41 and 41+10
          or ss_coupon_amt between 7893 and 7893+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 169 and 169+10
          or ss_coupon_amt between 6074 and 6074+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 138 and 138+10
          or ss_coupon_amt between 4172 and 4172+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 73 and 73+10
          or ss_coupon_amt between 10915 and 10915+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 61 and 61+10
          or ss_coupon_amt between 14319 and 14319+1000
