     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 81 and 81+10
          or ss_coupon_amt between 744 and 744+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 21 and 21+10
          or ss_coupon_amt between 15894 and 15894+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 70 and 70+10
          or ss_coupon_amt between 7756 and 7756+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 48 and 48+10
          or ss_coupon_amt between 8361 and 8361+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 0 and 0+10
          or ss_coupon_amt between 10074 and 10074+1000
