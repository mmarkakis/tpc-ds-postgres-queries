...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 59 and 59+10 
             or ss_coupon_amt between 10316 and 10316+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 166 and 166+10
          or ss_coupon_amt between 14345 and 14345+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 137 and 137+10
          or ss_coupon_amt between 6010 and 6010+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 17 and 17+10
          or ss_coupon_amt between 16031 and 16031+1000
