     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 15 and 15+10
          or ss_coupon_amt between 7439 and 7439+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 112 and 112+10
          or ss_coupon_amt between 2677 and 2677+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 69 and 69+10
          or ss_coupon_amt between 13935 and 13935+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 26 and 26+10
          or ss_coupon_amt between 2719 and 2719+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 135 and 135+10
          or ss_coupon_amt between 16214 and 16214+1000
