     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 98 and 98+10
          or ss_coupon_amt between 16882 and 16882+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 185 and 185+10
          or ss_coupon_amt between 8636 and 8636+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 11 and 11+10
          or ss_coupon_amt between 14982 and 14982+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 16 and 16+10
          or ss_coupon_amt between 6388 and 6388+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 87 and 87+10
          or ss_coupon_amt between 11322 and 11322+1000
