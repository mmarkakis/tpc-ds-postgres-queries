     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 111 and 111+10
          or ss_coupon_amt between 5769 and 5769+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 136 and 136+10
          or ss_coupon_amt between 6950 and 6950+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 71 and 71+10
          or ss_coupon_amt between 16679 and 16679+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 171 and 171+10
          or ss_coupon_amt between 6673 and 6673+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 151 and 151+10
          or ss_coupon_amt between 3790 and 3790+1000
