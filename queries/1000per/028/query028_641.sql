...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 173 and 173+10 
             or ss_coupon_amt between 4176 and 4176+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 57 and 57+10
          or ss_coupon_amt between 6597 and 6597+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 96 and 96+10
          or ss_coupon_amt between 4110 and 4110+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 70 and 70+10
          or ss_coupon_amt between 12133 and 12133+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 156 and 156+10
          or ss_coupon_amt between 1019 and 1019+1000
