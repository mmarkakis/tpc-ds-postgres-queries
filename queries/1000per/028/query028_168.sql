     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 2636 and 2636+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 29 and 29+10
          or ss_coupon_amt between 17276 and 17276+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 33 and 33+10
          or ss_coupon_amt between 13445 and 13445+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 124 and 124+10
          or ss_coupon_amt between 6311 and 6311+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 38 and 38+10
          or ss_coupon_amt between 10385 and 10385+1000
