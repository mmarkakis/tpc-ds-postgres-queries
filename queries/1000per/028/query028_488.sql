     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 15 and 15+10
          or ss_coupon_amt between 15258 and 15258+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 81 and 81+10
          or ss_coupon_amt between 224 and 224+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 51 and 51+10
          or ss_coupon_amt between 5610 and 5610+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 112 and 112+10
          or ss_coupon_amt between 17598 and 17598+1000
