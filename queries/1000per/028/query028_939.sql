...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 117 and 117+10 
             or ss_coupon_amt between 7289 and 7289+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 7 and 7+10
          or ss_coupon_amt between 10070 and 10070+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 118 and 118+10
          or ss_coupon_amt between 7992 and 7992+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 33 and 33+10
          or ss_coupon_amt between 513 and 513+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 65 and 65+10
          or ss_coupon_amt between 12807 and 12807+1000
