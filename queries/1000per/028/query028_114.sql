...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 44 and 44+10 
             or ss_coupon_amt between 12824 and 12824+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 10 and 10+10
          or ss_coupon_amt between 10032 and 10032+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 18 and 18+10
          or ss_coupon_amt between 15942 and 15942+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 105 and 105+10
          or ss_coupon_amt between 17379 and 17379+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 159 and 159+10
          or ss_coupon_amt between 12184 and 12184+1000
